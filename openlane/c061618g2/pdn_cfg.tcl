...
# Automatically compute the multi-net group cycle pitch by multiplying the env value by 2.0
...
# =============================================================================
# UNIFIED GEOMETRIC PAIR STRIPE ARRAYS (POWER FIRST)
# =============================================================================
# 1. Unified vertical command alternating nets natively across the whole width with VDD first
add_pdn_stripe -grid stdcell_grid -layer $::env(PDN_VERTICAL_LAYER) -width $::env(PDN_VWIDTH) -pitch $pattern_group_pitch -offset $true_on_grid_offset -spacing $::env(PDN_VSPACING) -nets "$::env(VDD_NET) $::env(GND_NET)" -extend_to_boundary

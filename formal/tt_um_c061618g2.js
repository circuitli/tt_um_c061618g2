...
// Grab the singleton Java instance of Framework and force-initialize the plugins
var frameworkClass = java.lang.Class.forName("org.workcraft.Framework");
var getInstanceMethod = frameworkClass.getMethod("getInstance", null);
var frameworkInstance = getInstanceMethod.invoke(null, null);

// Force Java to populate the plugin registry before continuing headless execution
var initPluginsMethod = frameworkClass.getDeclaredMethod("initPlugins", null);
initPluginsMethod.setAccessible(true);
initPluginsMethod.invoke(frameworkInstance, null);

...
The physical layout aligns with the Tiny Tapeout hardware tile format using the 130nm SiGe BiCMOS foundry platform (IHP SG13G2). The design operates safely up to a maximum nominal clock speed of 201 MHz.

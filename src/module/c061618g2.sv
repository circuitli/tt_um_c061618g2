...
module c061618g2 (
    ...
    // =========================================================================
    // 1. ISOLATE WRAPPER INPUT PADS TO STRIP STRUCTURAL TRISTATE METADATA
    // =========================================================================
    logic [7:0] local_ui_in;
    logic [7:0] local_uio_in;
    ...
    always_comb begin
        ...
        // ATARI MOMENT: Cartridge lines RD4/RD5 have physical 1k pull-downs!
        safe_ui[6] = (local_ui_in[6] === 1'bx || local_ui_in[6] === 1'bz) ? 1'b0 : local_ui_in[6]; // rd4 -> 0
        safe_ui[7] = (local_ui_in[7] === 1'bx || local_ui_in[7] === 1'bz) ? 1'b0 : local_ui_in[7]; // rd5 -> 0
        ...
        // Map remaining unreferenced buffer positions to resolve UNUSEDSIGNAL vectors
